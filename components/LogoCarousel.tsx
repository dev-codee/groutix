    ...
    <section className="py-10 bg-neutral-100 border-b border-neutral-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col space-y-4 items-center justify-center">
          <p className="text-sm uppercase font-extrabold tracking-widest text-neutral-400">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-12 w-full">
            {logos.map((logo, i) => (
              ...
              >
                <span className="text-[12px] font-black text-neutral-400 uppercase tracking-wider text-center">
                  {logo.name}
                </span>
              </div>
            ))}
