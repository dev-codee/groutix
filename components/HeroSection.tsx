        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="space-y-6 text-white">
            <div className="space-y-3">
              ...
              <p className="text-white/75 text-sm sm:text-[17px] max-w-xl leading-relaxed pt-2">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <a
                href="tel:70238094"
                className="flex items-center justify-center space-x-2 bg-[#2F63CC] hover:bg-[#264FA3] text-white font-black px-7 py-3.5 rounded-sm shadow-lg transition-all duration-200 text-sm"
              >
              ...
              <Link
                href="/contact"
                className="flex items-center justify-center bg-white/10 hover:bg-white/20 border border-white/30 text-white font-bold px-7 py-3.5 rounded-sm transition-all duration-200 text-sm"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-white/10">
              {[
                ...
                <div key={i} className="bg-white/8 border border-white/15 rounded-sm px-4 py-3">
                  <p className="text-sm font-black text-white" dangerouslySetInnerHTML={{ __html: b.stat }} />
                  <p className="text-[11px] text-white/60 mt-0.5">{b.sub}</p>
                </div>
              ))}
            </div>
          </div>
