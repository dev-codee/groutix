        ...
        <div className="flex flex-wrap justify-center gap-2 mb-12">
          {categories.map((cat) => (
            <button
              ...
              className={`px-5 py-2 rounded-full font-bold text-xs tracking-wider uppercase transition-all duration-200 cursor-pointer ${
                activeTab === cat.id
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col space-y-2">
                  <div className="bg-neutral-100 border border-neutral-200 rounded h-48 flex items-center justify-center relative overflow-hidden group">
                    <div className="text-center p-4">
                      <span className="absolute top-2 left-2 bg-red-600 text-white font-bold text-[9px] uppercase px-1.5 py-0.5 rounded tracking-wider shadow">
                        Before
                      </span>
                      <p className="font-bold text-neutral-500 uppercase tracking-widest text-[9px]">
                        Before Image Space
                      </p>
                      <p className="text-[9px] text-neutral-400 mt-1">Add picture manually</p>
                    </div>
                    {/* Before grid pattern */}
                ...
                <div className="flex flex-col space-y-2">
                  <div className="bg-neutral-100 border border-neutral-200 rounded h-48 flex items-center justify-center relative overflow-hidden group">
                    <div className="text-center p-4">
                      <span className="absolute top-2 left-2 bg-emerald-600 text-white font-bold text-[9px] uppercase px-1.5 py-0.5 rounded tracking-wider shadow">
                        After
                      </span>
                      <p className="font-bold text-neutral-500 uppercase tracking-widest text-[9px]">
                        After Image Space
                  ...
                  <p className="text-xs text-neutral-600 leading-relaxed font-semibold flex items-start space-x-1">
