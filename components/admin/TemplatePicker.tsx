    ...
    <>
      ...
      {buttonLabel ? (
        <button
          ...
          className={
            triggerClassName ||
            "flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-700 font-semibold text-xs rounded-lg transition-colors"
          }
        >
                      ...
                      <div className="flex items-start justify-between gap-2">
                        <div className="space-y-1 min-w-0 flex-1">
                          <div className="flex items-center gap-1.5 flex-wrap">
                            <span className="font-mono font-bold text-[10px] px-2 py-0.5 rounded-md bg-blue-600 text-white">
                              {t.code}
                            </span>
                            ...
                            {t.service.toLowerCase().includes("polymer") && (
                              <span className="text-[10px] font-semibold px-1.5 py-0.5 rounded bg-blue-50 text-blue-800 border border-blue-200/60">
                                Polymer
                              </span>
                            )}
