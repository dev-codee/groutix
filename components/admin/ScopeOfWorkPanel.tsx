...
export function ScopeOfWorkPanel({ lead: l, onSave, onSaveNotes, readOnly = true }: Props) {
  ...
  return (
    <div className="border border-blue-200/60 rounded-xl bg-blue-50/20 overflow-hidden">
      ...
      <button
        ...
        className="w-full flex items-center justify-between px-2.5 py-2 hover:bg-blue-50/50 transition-colors cursor-pointer text-left select-none"
        title={open ? "Click to collapse Scope of Work" : "Click to view Scope of Work"}
      >
        <div className="flex items-center gap-2 flex-wrap min-w-0">
          <span className="text-[10.5px] font-bold text-blue-800 uppercase tracking-wider flex items-center gap-1.5">
            Scope of Work
          </span>
          {readOnly && (
          ...
          {extraNotes && (
            <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full text-[9px] font-semibold bg-amber-50 text-amber-900 border border-amber-200/80 shadow-2xs">
      ...
      {/* Expanded Content */}
      {open && (
        <div className="px-2.5 pb-2.5 pt-2 border-t border-blue-200/40 bg-white/80 space-y-3">
          ...
          {editingScope && !readOnly ? (
            <div className="space-y-2">
              <textarea
                ...
                rows={8}
                autoFocus
                className="w-full text-[11px] text-slate-800 leading-relaxed border border-blue-200 rounded-lg p-2.5 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 resize-y bg-white shadow-inner font-sans"
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-[10.5px] font-semibold rounded-lg transition-colors cursor-pointer shadow-xs disabled:opacity-60"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-3 py-1.5 border border-slate-200 bg-slate-100 hover:bg-slate-200 text-slate-700 text-[10.5px] font-semibold rounded-lg transition-colors cursor-pointer"
                >
                  <X className="w-3 h-3" />
                  Cancel
                </button>
                      ...
                      {sec.bullets.length > 0 && (
                        <ul className="space-y-1 pl-1">
                          {sec.bullets.map((bullet, bi) => (
                            ...
                            >
                              <span className="mt-[5px] w-1.5 h-1.5 rounded-full bg-blue-600 shrink-0" />
              ...
              {!readOnly && (
                <div className="pt-1 border-t border-slate-100">
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2 py-1 rounded bg-blue-50 hover:bg-blue-100 text-[10.5px] font-semibold text-blue-700 transition-colors cursor-pointer"
                  >
          ...
          <div className="pt-2 border-t border-slate-200/70">
            <div className="flex items-center justify-between mb-1.5">
              <span className="text-[10.5px] font-bold uppercase tracking-wider text-slate-800 flex items-center gap-1.5">
              ...
              {!editingNotes && extraNotes && (
                <button
                  ...
                  className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-semibold text-blue-700 bg-blue-50 hover:bg-blue-100 transition-colors cursor-pointer"
                >
                  <Pencil className="w-3 h-3" />
                  Edit Note
                </button>
            ...
            {editingNotes ? (
              <div className="space-y-2">
                <textarea
                  ...
                  rows={3}
                  autoFocus
                  className="w-full text-xs text-slate-800 leading-relaxed border border-amber-300 rounded-lg p-2.5 focus:outline-none focus:ring-1 focus:ring-blue-500 bg-white shadow-inner"
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-[10.5px] font-semibold rounded-lg transition-colors cursor-pointer shadow-xs disabled:opacity-60"
                  >
              ...
              <div className="flex items-center justify-between p-2 rounded-lg bg-slate-50 border border-dashed border-slate-200">
                ...
                <button
                  type="button"
                  onClick={handleStartEditNotes}
                  className="inline-flex items-center gap-1 px-2.5 py-1 rounded bg-blue-600 hover:bg-blue-700 text-white text-[10px] font-semibold transition-colors cursor-pointer shadow-2xs"
                >
