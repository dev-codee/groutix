  ...
  return (
    <section className="bg-secondary py-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-8 text-white text-center md:text-left relative z-10">
        <div>
          <h2 className="text-3xl font-black tracking-tight">Ready to fix your grout <span className="text-accent">the right way</span>?</h2>
            <p className="text-white/80 mt-2 text-base">Free quotes, clear advice, and expert shower repair service.</p>
        </div>
