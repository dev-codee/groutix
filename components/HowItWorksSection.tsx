      ...
      <section className="bg-[#F3F4F6] py-16 lg:py-24">
        <div className="max-w-[1460px] mx-auto px-6 lg:px-10 space-y-10">
          <div className="max-w-3xl space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 text-neutral-600 leading-relaxed text-sm sm:text-[16px]">
              <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {steps.map((step, i) => (
              <div key={i} className="space-y-4">
                {/* Step number */}
                <div className="inline-flex items-center justify-center h-10 w-10 rounded-full bg-[#001F97] text-white font-black text-sm">
                  {step.number}
                </div>
