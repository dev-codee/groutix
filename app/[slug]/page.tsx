...
const services: Record<string, {
  ...
  "balcony-leak-repairs": {
    ...
    metaTitle: "Balcony Leak Repairs | GROUTIX Australia",
    metaDesc: "Expert balcony leak repairs in Melbourne. We fix failed grout, deteriorated sealants and tiled balcony surfaces to stop water ingress without unnecessary tile removal.",
    h1Desc: "Leaking balconies can cause serious water damage to your home and the structure below if left untreated. GROUTIX repairs failed grout, deteriorated sealants and tiled balcony surfaces to stop water ingress — without unnecessary tile removal.",
    ...
    workWithUsText: "GROUTIX provides professional balcony leak repairs across Melbourne and surrounding areas. We understand the specific demands of outdoor tiled surfaces and use materials designed to perform in exposed conditions — giving you a properly repaired balcony backed by our workmanship warranty.",
    workWithUsBullets: [
    ...
    faqs: [
      ...
      { q: "Do you service apartment balconies?", a: "Yes. We regularly repair balconies in residential apartment buildings, townhouses and freestanding homes across Melbourne." },
    ],
  },

  "silicone-recaulking": {
    title: "Silicone & Recaulking",
    metaTitle: "Silicone Replacement & Recaulking | GROUTIX Australia",
    metaDesc: "Professional silicone removal and replacement for showers, baths, kitchens and wet areas across Melbourne. Mould-resistant sealants and premium finish.",
    h1Desc: "Cracked, mouldy or peeling silicone is more than an eyesore — it leaves your shower, bath or kitchen vulnerable to water ingress and further damage. GROUTIX replaces deteriorated silicone with premium mould-resistant sealants to restore a durable, watertight seal.",
    ...
    workWithUsText: "GROUTIX provides professional silicone replacement and recaulking for showers, baths, kitchens and wet areas across Melbourne. We use premium mould-resistant products and take care to complete every job to a neat, professional standard.",
    workWithUsBullets: [
  ...
  "epoxy-grout": {
    title: "Epoxy Grout",
    metaTitle: "Epoxy Grout Installation & Upgrade | GROUTIX Australia",
    metaDesc: "Upgrade your shower, balcony or tiled area to commercial-grade epoxy grout. Superior stain resistance, durability and long-term performance across Melbourne.",
    h1Desc: "Upgrade your tiled areas with commercial-grade epoxy grout for superior stain resistance, durability and long-term performance. Unlike traditional cement grout, epoxy grout is non-porous, highly water-resistant and built to last — ideal for showers, balconies and other high-moisture environments.",
