...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `Shower Regrouting ${name} | Frankston | GROUTIX`,
    description: `Specialist shower regrouting, grout repair and leaking shower services in ${name}, Frankston. Professional wet-area repairs backed by a 10-year waterproof guarantee.`,
    alternates: { canonical: `/locations/frankston/${suburb}` },
    openGraph: {
      title: `Shower Regrouting ${name} | Frankston — GROUTIX`,
      description: `Local shower regrouting, grout repair and leaking shower solutions in ${name}, Frankston. Free quotes and specialist workmanship.`,
      url: `/locations/frankston/${suburb}`,
      type: "website",
    },
  };
}
...
export default async function SuburbPage({ params }: Props) {
  ...
  const serviceAreaText = `GROUTIX provides shower regrouting, grout repair, silicone replacement and leaking shower repairs across ${suburbName} and the greater Frankston region. We target failed grout joints and worn seals without turning a repair into a full renovation.
  ...
  return (
    <>
      ...
      <CityPageClient
        ...
        heroSubtitle={`Professional shower regrouting, grout repair and leaking shower services in ${suburbName}, Frankston. GROUTIX restores wet areas without unnecessary tile removal and backs full shower regrouting with a 10-year waterproof guarantee.`}
