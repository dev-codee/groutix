...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: `Specialist shower regrouting, grout repair and leaking shower services in ${name}, Frankston. Professional wet-area repairs backed by a 10-year waterproof warranty.`,
