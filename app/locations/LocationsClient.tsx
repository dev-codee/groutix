  ...
  return (
    <main>
      ...
      <motion.section
        ...
        className="relative bg-primary overflow-hidden pt-[73px]"
      >
        ...
        <div className="relative z-10 max-w-[1460px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 items-stretch">
            <motion.div
              ...
              className="p-8 lg:p-16 flex flex-col justify-center text-white space-y-6"
            >
            ...
            <AnimatedImage className="relative min-h-[250px] lg:min-h-[500px]" delay={0.3}>
              <ImgBox src="/img20.jpeg" label="Melbourne Location Bridge Image" aspect="h-full w-full absolute inset-0" className="border-0" />
            </AnimatedImage>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border-t border-white/20">
            {[
              ...
              <motion.div
                ...
                className="flex items-center gap-4 bg-[#2F63CC]/90 text-white p-6 border-r border-white/10 last:border-r-0"
              >
                <span className="text-2xl">{badge.icon}</span>
                <span className="text-base font-bold leading-snug">{badge.label}</span>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <AnimatedSection className="bg-white py-8 border-b border-neutral-100">
        <div className="max-w-[1460px] mx-auto px-6 lg:px-10 flex flex-wrap items-center justify-center gap-8 lg:gap-14 opacity-60 grayscale">
          {["LOVE & CO", "McGrath", "PPM Perth Property Management", "Professionals", "Ray White", "RMA rental management australia", "RP REAL PROPERTY WA"].map((l, i) => (
            <motion.span
              key={l}
...
Every quote is free, every job is properly warranted, and our team works around your schedule. We treat heritage terraces, brick veneers, and modern apartments with the same standard of care. If your grout is grey, your shower is leaking, or your bathroom is past its best, book your local GROUTIX specialist in Melbourne today.`.split("\n\n").map((para, i) => (
      ...
      {/* Final Quote Form */}
      <section id="quote-form" className="relative overflow-hidden bg-primary">
        <div className="absolute inset-0">
          <Image src="/img21.jpeg" alt="Bathroom Background Image" fill className="object-cover" />
          <div className="absolute inset-0 bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:20px_20px]" />
        </div>
